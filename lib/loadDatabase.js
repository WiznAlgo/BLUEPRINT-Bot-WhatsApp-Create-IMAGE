/*
 * Database Loader Blueprint
 * Initialize user & group data dengan default values
 * Creator: WiznAlgo
 */
...
export default function loadDatabase(m) {
    // [Blueprint] Helper validation functions
    const isNumber = x => typeof x === "number" && !isNaN(x)
    const isBoolean = x => typeof x === "boolean" && Boolean(x)
    
    // [Blueprint] Load/init user data dengan struktur default
    ...
    // [Blueprint] Load/init group data (jika pesan dari grup)
    if (m.isGroup) {
